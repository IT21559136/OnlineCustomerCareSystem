...
<a href="aquestions.jsp" id="btn1"class="btn btn-rounded">All Questions</a></button></span>
<span style="float : right; ">
<a href="NewQuestion.jsp" id="btn2"class="btn btn-rounded">Ask Question</a></span>
</h2>
<br>
